...
EntityEvents.spawned(event => {
    ...
    if (entity.type.namespace === 'humancompanions') {
        try {
            ...
            entity.targetSelector.addGoal(2, new NearestAttackableTargetGoal(entity, CreeperClass, true));
        } catch (e) {
            console.log('[HumanCompanions AI] AvoidCreeperGoal removed smoothly: ' + e);
        }
    }
});
