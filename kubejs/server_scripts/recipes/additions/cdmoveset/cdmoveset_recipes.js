...
ServerEvents.recipes(event => {
    const cdOutputs = [
        ...
        'cdmoveset:great_tachi', 'cdmoveset:phantom_katana'
    ];
    ...
    // Netherite Sword (Chế tạo Bàn Chế Tạo 3x3)
    event.shaped('cdmoveset:s_netherite_sword', [
        ' T ',
        ' N ',
        ' S '
    ], {
    ...
    // Netherite Greatsword (Chế tạo Bàn Chế Tạo 3x3)
    event.shaped('cdmoveset:s_netherite_greatsword', [
        ' T ',
        ' N ',
        ' S '
    ], {
        T: 'minecraft:netherite_upgrade_smithing_template',
        N: 'minecraft:netherite_ingot',
        S: 'cdmoveset:s_diamond_greatsword'
    }).stage('stage_warrior');
});
