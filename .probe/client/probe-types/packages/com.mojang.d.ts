...
export class $PoseStack implements $IForgePoseStack, $CachingPoseStack {
...
public "handler$bjg000$epicfight_setQuadSortOrigin"(arg0: $VertexSorting$Type, arg1: $CallbackInfo$Type): void
...
public "redirect$bjg000$epicfight_storeRenderedBuffer"(arg0: $BufferBuilder$Type, arg1: $VertexFormat$IndexType$Type): void
public "localvar$bcj000$vertex"(alpha: float): float
public "discard"(): void
