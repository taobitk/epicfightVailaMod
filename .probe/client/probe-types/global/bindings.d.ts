...
import {$SkillSlots, $SkillSlots$Type} from "packages/yesman/epicfight/skill/$SkillSlots"
...
import {$EFUtilsJS, $EFUtilsJS$Type} from "packages/yesman/epicfight/compat/kubejs/$EFUtilsJS"
...
import {$EpicFightCapabilities, $EpicFightCapabilities$Type} from "packages/yesman/epicfight/world/capabilities/$EpicFightCapabilities"
import {$ClientEngine, $ClientEngine$Type} from "packages/yesman/epicfight/client/$ClientEngine"
...
import {$SkillDataKeys, $SkillDataKeys$Type} from "packages/yesman/epicfight/skill/$SkillDataKeys"
...
import {$AAALevel, $AAALevel$Type} from "packages/mod/chloeprime/aaaparticles/api/common/$AAALevel"
...
const PlayerPatch: typeof $PlayerPatch
const EventType: typeof $PlayerEventListener$EventType
const OutputItem: typeof $OutputItem
const RotationAxis: typeof $RotationAxis
const LocalPlayerPatch: typeof $LocalPlayerPatch
const Painter: $Painter
const Items: typeof $Items
const MINUTE: double
const BlockPos: typeof $BlockPos
const ServerPlayerPatch: typeof $ServerPlayerPatch
const Client: $Minecraft
const SoundType: typeof $SoundType
const ClientEngine: $ClientEngine
...
const SkillSlots: typeof $SkillSlots
const EFUtils: typeof $EFUtilsJS
const InputItem: typeof $InputItem
const AAAParticles: typeof $AAALevel
const SECOND: double
