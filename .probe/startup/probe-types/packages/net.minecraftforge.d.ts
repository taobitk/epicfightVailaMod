...
import {$ListenerList, $ListenerList$Type} from "packages/net/minecraftforge/eventbus/$ListenerList"
import {$Event, $Event$Type} from "packages/net/minecraftforge/eventbus/api/$Event"
import {$EACAccess, $EACAccess$Type} from "packages/net/liopyu/entityjs/util/implementation/$EACAccess"
...
(arg0: $BlockState$Type, arg1: $BlockGetter$Type, arg2: $BlockPos$Type, arg3: $Direction$Type, arg4: $IPlantable$Type): boolean
}
...
(arg0: $ItemStack$Type, arg1: $CompoundTag$Type): void
}
...
public "handler$bba000$iris$handleHudHidingScreens"(pGui0: $GuiGraphics$Type, pFloat1: float, ci: $CallbackInfo$Type): void
