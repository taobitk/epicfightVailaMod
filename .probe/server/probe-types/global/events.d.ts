...
import {$AddGoalSelectorsEventJS, $AddGoalSelectorsEventJS$Type} from "packages/net/liopyu/entityjs/events/$AddGoalSelectorsEventJS"
...
import {$AddGoalTargetsEventJS, $AddGoalTargetsEventJS$Type} from "packages/net/liopyu/entityjs/events/$AddGoalTargetsEventJS"
...
function buildBrain(extra: string, handler: (event: $BuildBrainEventJS<(any)>) => void): void
function addGoalSelectors(extra: string, handler: (event: $AddGoalSelectorsEventJS<(any)>) => void): void
function buildBrainProvider(extra: string, handler: (event: $BuildBrainProviderEventJS<(any)>) => void): void
function addGoals(extra: string, handler: (event: $AddGoalTargetsEventJS<(any)>) => void): void
