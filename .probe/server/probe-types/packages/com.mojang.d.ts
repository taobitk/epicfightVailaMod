...
(arg0: $IntFunction$Type<($TypedOptic$Type<(any), (any), (A), (B)>)>): $FamilyOptic<(A), (B)>
}
...
export class $PoseStack implements $IForgePoseStack, $CachingPoseStack, $PoseStackExt {
...
(): $Function<(T1), ($Function7<(T2), (T3), (T4), (T5), (T6), (T7), (T8), (R)>)>
}
...
(): $Function<(T1), ($Function6<(T2), (T3), (T4), (T5), (T6), (T7), (R)>)>
}
...
(): $Function<(T1), ($Function5<(T2), (T3), (T4), (T5), (T6), (R)>)>
}
...
(): $Function<(T1), ($Function4<(T2), (T3), (T4), (T5), (R)>)>
}
...
(): $Function<(T1), ($Function8<(T2), (T3), (T4), (T5), (T6), (T7), (T8), (T9), (R)>)>
}
...
(): $Function<(T1), ($Function3<(T2), (T3), (T4), (R)>)>
}
...
(): $Function<(T1), ($BiFunction<(T2), (T3), (R)>)>
}
...
public "handler$cfb000$epicfight_setQuadSortOrigin"(arg0: $VertexSorting$Type, arg1: $CallbackInfo$Type): void
...
public "redirect$cfb000$epicfight_storeRenderedBuffer"(arg0: $BufferBuilder$Type, arg1: $VertexFormat$IndexType$Type): void
public "localvar$bbb000$vertex"(alpha: float): float
public "discard"(): void
...
(arg0: $Supplier$Type<($Stream$Type<(string)>)>): $Keyable
}
...
(arg0: $Type$Type<(B)>, arg1: $RewriteResult$Type<(B), (any)>): $TypeRewriteRule
}
...
(arg0: $PointFreeRule$Type, arg1: $PointFreeRule$Type): $PointFreeRule
}
