...
import {$BuilderBase, $BuilderBase$Type} from "packages/dev/latvian/mods/kubejs/registry/$BuilderBase"
import {$RegistryInfo, $RegistryInfo$Type} from "packages/dev/latvian/mods/kubejs/registry/$RegistryInfo"
import {$IRegistryJS, $IRegistryJS$Type} from "packages/net/liopyu/entityjs/util/implementation/$IRegistryJS"
import {$CustomEntityBuilder, $CustomEntityBuilder$Type} from "packages/net/liopyu/entityjs/builders/misc/$CustomEntityBuilder"

export class $RegistryEventJS<T> extends $StartupEventJS implements $IRegistryJS {
 ...
 * ```
 */
public "createCustom"(id: string, entityClass: $Class$Type<(any)>, consumer: $Consumer$Type<(any)>): $CustomEntityBuilder
...
export interface $ItemKJS extends $IngredientSupplierKJS {
 ...
 "overrideFood"(properties: $FoodProperties$Type): void
...
import {$PickBlockCallbackJS, $PickBlockCallbackJS$Type} from "packages/dev/latvian/mods/kubejs/block/$PickBlockCallbackJS"
import {$JsonObject, $JsonObject$Type} from "packages/com/google/gson/$JsonObject"
import {$Component, $Component$Type} from "packages/net/minecraft/network/chat/$Component"
import {$Consumer, $Consumer$Type} from "packages/java/util/function/$Consumer"
import {$LootBuilder, $LootBuilder$Type} from "packages/dev/latvian/mods/kubejs/loot/$LootBuilder"
...
export class $FenceBlockBuilder extends $MultipartShapedBlockBuilder {
 ...
 "pickBlockCallback": $Consumer<($PickBlockCallbackJS)>
...
declare module "packages/dev/latvian/mods/kubejs/block/$PickBlockCallbackJS" {
import {$Item, $Item$Type} from "packages/net/minecraft/world/item/$Item"
import {$BlockGetter, $BlockGetter$Type} from "packages/net/minecraft/world/level/$BlockGetter"
import {$BlockState, $BlockState$Type} from "packages/net/minecraft/world/level/block/state/$BlockState"
import {$BlockPos, $BlockPos$Type} from "packages/net/minecraft/core/$BlockPos"

export class $PickBlockCallbackJS {
 "block": $BlockGetter
 "pos": $BlockPos
 "state": $BlockState
 "item": $Item

constructor(blockGetter: $BlockGetter$Type, blockPos: $BlockPos$Type, blockState: $BlockState$Type)

public "getBlockGetter"(): $BlockGetter
public "setPickBlockItem"(item: string): void
public "getBlockPos"(): $BlockPos
public "getState"(): $BlockState
get "blockGetter"(): $BlockGetter
set "pickBlockItem"(value: string)
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $PickBlockCallbackJS$Type = ($PickBlockCallbackJS);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type $PickBlockCallbackJS_ = $PickBlockCallbackJS$Type;
}}
...
(arg0: $BlockState$Type, arg1: $BlockAndTintGetter$Type, arg2: $BlockPos$Type, arg3: integer): $Color
}
...
public "handler$bif000$loadJavaClass"(name0: string, warn: boolean, cir: $CallbackInfoReturnable$Type<(any)>): void
...
(recipe: $RecipeJS$Type, value: T, match: $ReplacementMatch$Type): boolean
}
 ...
 */
public "pickBlock"(pickBlockCallback: $Consumer$Type<($PickBlockCallbackJS$Type)>): $BlockBuilder
/**
...
(x: integer, y: integer, z: integer): $BlockContainerJS
}
...
public static "of"(cx: $Context$Type, o: any): $FoodProperties
...
(arg0: $ItemStack$Type, arg1: integer): $Color
}
